...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.04.28, June 17, 2023 18:08:25):
...
app_logger.info(f'Created June 17, 2023 18:08:25 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.04.28\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.04.28\n'
    if is_docker():
