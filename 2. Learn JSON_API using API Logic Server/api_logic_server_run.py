...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.04.29, June 19, 2023 08:10:31):
...
app_logger.info(f'Created June 19, 2023 08:10:31 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.04.29\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.04.29\n'
    if is_docker():
